		...
		<div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="${aroot}/servicefront/list"><i class="fa fa-dashboard"></i> 首页</a>
                    </li>
                    <li>
                        <a href="${aroot}/servicefront/xinxi"><i class="fa fa-desktop"></i> 信息管理</a>
                    </li>
					<li>
                        <a  href="${aroot}/servicefront/item"><i class="fa fa-bar-chart-o"></i> 服务项目</a>
                    </li>
					<li>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<c:forEach var="eo" items="${datalist1}">
											<tr >
												<td>${eo.orders_id}</td>
												<td>${eo.item_name}</td>
