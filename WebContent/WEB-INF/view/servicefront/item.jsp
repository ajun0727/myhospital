		...
		<div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="${aroot}/servicefront/list"><i class="fa fa-dashboard"></i> 首页</a>
                    </li>
                    <li>
                        <a href="${aroot}/servicefront/xinxi"><i class="fa fa-desktop"></i> 信息管理</a>
                    </li>
					<li>
                        <a class="active-menu" href="${aroot}/servicefront/item"><i class="fa fa-bar-chart-o"></i> 服务项目</a>
                    </li>
					<li>
                        <a href="${aroot}/servicefront/orders"><i class="fa fa-bar-chart-o"></i> 工单管理</a>
                    </li>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach var="eo" items="${datalist3}">
											<tr >
												<td>${eo.id}</td>
												<td>${eo.item_name}</td>
												<td>${eo.item_Introduction }</td>
												<td>${eo.item_price }</td>
