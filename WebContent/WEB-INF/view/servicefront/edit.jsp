...
<title>添加工单 - H-ui.admin v3.1</title>
<meta name="keywords" content="H-ui.admin v3.1,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
<meta name="description" content="H-ui.admin v3.1，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<body>
	<article class="page-container">
		<form action="${aroot}/servicefront/save" method="post" class="form form-horizontal" id="form-edit">
			<input type="hidden" name="orders_id" value="${eo.orders_id}" />
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>服务项目：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.item_name }" placeholder="" id="item_name" name="item_name">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>客户姓名：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.client_name }" placeholder="" id="client_name" name="client_name">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>客户电话：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.client_tel }" placeholder="" id="client_tel" name="client_tel">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">服务地址：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.service_address }" placeholder="" id="service_address" name="service_address">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.orders_time }" placeholder="" id="orders_time" name="orders_time">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>服务时间：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.service_time }" placeholder="" id="service_time" name="service_time">
				</div>
			</div>
			<div class="row cl">
