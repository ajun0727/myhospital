		...
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<div >
									...
									<form action="${aroot}/servicefront/xinxisave" method="post" role="form" id="form-edit">
                                        <div class="form-group has-success">
                                            <label class="control-label" for="inputSuccess">服务商姓名：</label>
                                            <input type="text" class="form-control" id="service_name" value="${eo.service_name }" name="service_name">
                                        </div>
                                        <div class="form-group has-error">
                                            <label class="control-label" for="inputSuccess">服务商电话：</label>
                                            <input type="text" class="form-control" id="service_tel" value="${eo.service_tel }" name="service_tel">
                                        </div>
                                        <div class="form-group has-success">
                                            <label class="control-label" for="inputSuccess">服务商地址：</label>
                                            <input type="text" class="form-control" id="service_adress" value="${eo.service_adress }" name="service_adress">
                                        </div>
