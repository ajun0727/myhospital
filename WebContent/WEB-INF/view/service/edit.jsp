...
<body>
	<article class="page-container">
		<form action="${aroot}/service/save" method="post" class="form form-horizontal" id="form-edit">
			<input type="hidden" name="service_id" value="${eo.service_id}" />
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>服务商姓名：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.service_name }" placeholder="" id="service_name" name="service_name">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>服务商电话：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.service_tel }" placeholder="" id="service_tel" name="service_tel">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">服务商地址：</label>
				<div class="formControls col-xs-8 col-sm-9">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.account }" placeholder="" id="account" name="account">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>密码：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${eo.password }" placeholder="" id="password" name="password">
				</div>
			</div>
			<div class="row cl">
