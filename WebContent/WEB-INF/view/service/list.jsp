...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 服务商管理 <span class="c-gray en">&gt;</span> 服务商列表 <a
	...
	<div class="page-container">
		<div class="text-c">
			<form action="${aroot}/service/list" method="get">
				服务商编号<input type="text" class="input-text" style="width: 250px" placeholder="输入服务商编号" id="" name="service_id"> 服务商姓名<input
					type="text" class="input-text" style="width: 250px" placeholder="输入服务商姓名" id="" name="service_name">
				<button type="submit" class="btn btn-success radius" id="" name="">
					<i class="Hui-iconfont">&#xe665;</i> 搜服务商
				</button>
			</form>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"> <a href="javascript:;" onclick="member_add('添加服务商','${aroot}/service/add','','510')"
				class="btn btn-primary radius"> <i class="Hui-iconfont">&#xe600;</i> 添加服务商
			</a>
			</span>
		</div>
		<div class="mt-20">
			<table class="table table-border table-bordered table-hover table-bg table-sort">
				<thead>
					<tr class="text-c">
						<th width="80">服务商编号</th>
						<th width="80">服务商姓名</th>
						<th width="50">电话</th> 
						<th width="50">地址</th> 
						<th width="50">账号</th> 
						<th width="50">密码</th> 
				...
				<tbody>
					<c:forEach var="eo" items="${datalist}">
						<tr class="text-c">
						    <td>${eo.service_id}</td>
							<td>${eo.service_name }</td>
							<td>${eo.service_tel }</td>
							<td>${eo.service_address }</td>
							<td>${eo.account }</td>
							<td>${eo.password }</td>
							
							<td class="td-manage"><a title="编辑" href="javascript:;"
								onclick="member_edit('编辑','${aroot}/service/edit/${eo.service_id }','4','','510')" class="ml-5" style="text-decoration: none"> <i
									class="Hui-iconfont">&#xe6df;</i>
							</a> <a title="删除" href="javascript:;" onclick="member_del(this,'${eo.service_id }')" class="ml-5" style="text-decoration: none"> <i
									class="Hui-iconfont">&#xe6e2;</i>
							</a></td>
						</tr>
					</c:forEach>
