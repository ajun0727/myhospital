		...
		<div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="${aroot}/doctorfront/list"><i class="fa fa-dashboard"></i> 首页</a>
                    </li>
                    <li>
                        <a href="${aroot}/doctorfront/list"><i class="fa fa-desktop"></i> 医生管理</a>
                    </li>
					<li>
                        <a  href="${aroot}/doctorfront/list"><i class="fa fa-bar-chart-o"></i> 治疗项目</a>
                    </li>
                    <li>
                        <a href="${aroot}/doctorfront/list"><i class="fa fa-qrcode"></i>投诉管理</a>
                    </li>
                    
                    <li>
                        <a href="${aroot}/doctorfront/list"><i class="fa fa-table"></i> 
						评价管理</a>
                    </li>
            ...
            <div id="page-inner">
                ...
                <div class="row">
					...
					<div class="col-md-8 col-sm-12 col-xs-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">下属老人详情</div>
							<div class="panel-body">
