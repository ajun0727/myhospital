...
<title></title>
<!-- Fav Icons   -->
<link rel="icon" href="${next}/images/favicon.png" type="image/x-icon">
<!-- Bootstrap -->
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">
          ...
          <!-- <img src="${next}/images/logo.png" alt="logo"> -->
        </a> 
      </div>
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" data-hover="dropdown" data-animations="fadeIn fadeInLeft fadeInUp fadeInRight">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="${aroot}index.jsp">Home</a></li>
          <li class="active"><a href="aboutus.jsp">About us </a></li>
          <li><a href="${aroot}services.jsp">Services </a></li>
          <li><a href="${aroot}contact.jsp">Contact Us</a></li>
        </ul>
      </div>
      <!--/.nav-collapse --> 
    </div>
      ...
      <div class="col-md-6 col-lg-6">
        <div class="breadcrumbs">
          <ul>
            <li>Current Page:</li>
            <li><a href="${aroot}index.jsp">Home</a></li>
            <li><a href="${aroot}aboutus.jsp">About us</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="section18">
    <div class="row">
      ...
      <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay=".2s">
        <div class="section-18-img">
          <img src="${next}/images/a0.jpg"  class="img-responsive" alt="">
        </div>
      </div>
    </div>
    <div class="row mission-vision">
      <div class="col-sm-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
        <figure>
          <img src="${next}/images/a2.jpg"  class="img-responsive" alt="">
        </figure>
      ...
      <div class="col-sm-6 col-md-6 wow fadeInUp" data-wow-delay=".4s">
        <figure>
          <img src="${next}/images/a1.jpg"  class="img-responsive" alt="">
        </figure>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-lg-9">
        <div class="copyright">Copyright &copy; 2017.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></div>
      </div>
      <div class="col-md-3 col-lg-3">
